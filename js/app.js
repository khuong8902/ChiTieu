...
function showDayDetail(date){
    ...
    result.forEach((item,index)=>{
        ...
        const percent=Math.round(
            item.total/Math.max(total,1)*100
        );
...
$("btnBackup").onclick = ()=>{
    ...
    setting.lastBackup = new Date().toLocaleString("vi-VN");
...
$("btnExcel").onclick = ()=>{
    ...
    XLSX.writeFile(wb,"DuLieuChiTieu.xlsx");
